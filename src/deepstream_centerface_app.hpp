...
namespace CenterFace{
  class Nexus {
    private:
      gchar pgie_centerface_classes_str[1][10] = {
          "Face"
        };
      ...
      inline static char *PGIE_CENTERFACE_DETECTOR_CONFIG_FILE_PATH;
    ...
    public:
      ...
      std::string PGIE_CENTERFACE_ENGINE_PATH;
      ...
      int
      configure_element_properties(int num_sources, GstElement *streammux, GstElement *pgie_centerface_detector,
